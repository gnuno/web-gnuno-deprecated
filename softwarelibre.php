    ...
    <div class="cuadrocentral">
        <div class="articulovistahome">
            ...
            <ul style="list-style: disc; margin-top:15px">
                <li>La libertad de ejecutar el programa como se desea, con cualquier propósito <font style="font-weight:bolder">(Libertad 0)</font>.</li>
                <li>La libertad de estudiar cómo funciona el programa, y cambiarlo para que haga lo que usted quiera <font style="font-weight:bolder">(libertad 1)</font>. El acceso al código fuente es una condición necesaria para ello. </li>
                <li>La libertad de redistribuir copias para ayudar a su prójimo <font style="font-weight:bolder">(libertad 2)</font>.</li>

                <li>La libertad de distribuir copias de sus versiones modificadas a terceros <font style="font-weight:bolder">(libertad 3)</font>. Esto le permite ofrecer a toda la comunidad la oportunidad de beneficiarse de las modificaciones. El acceso al código fuente es una condición necesaria para ello.</li>
            </ul>
            <h4 style="font-weight: bolder; font-family: monospace">Linux y el sistema GNU
            </h4>
            <p style="font-family: monospace">Muchos usuarios de ordenadores ejecutan a diario, sin saberlo, una versión modificada del sistema GNU. Debido a un peculiar giro de los acontecimientos, a la versión de GNU ampliamente utilizada hoy en día se la llama a menudo «Linux», y muchos de quienes la usan no se dan cuenta de que básicamente se trata del sistema GNU, desarrollado por el proyecto GNU.
