...
?>
    <div class="articulovistahome">
        <p style="font-family: monospace">Solicitá acceso a la lista de correos haciendo click
            <a target="_blank" href="http://lista.gnuno.com.ar/listinfo/uno-informatica">ACÁ</a>.</p>

        <hr>

        <p style="font-family: monospace">También podés entrar al
            <a target="_blank" href="http://www.uno-foros.com.ar/viewforum.php?f=250">FORO</a>
        </p>
        ...
        <form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <span style="color:red">*
                <?php if ($errorNombre != '') echo $errorNombre;?>
            </span>
            <br> Email:
            ...
            <span style="color:red">*
                <?php if ($errorMensaje != '') echo $errorMensaje;?>
            </span>
            <br>
